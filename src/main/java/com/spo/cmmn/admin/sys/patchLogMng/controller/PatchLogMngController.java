package com.spo.cmmn.admin.sys.patchLogMng.controller;
...
@Controller
@RequestMapping(value="/api/admin/sys/patchLogMng")
public class PatchLogMngController {
	private final Logger LOGGER = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
	
	
	@Autowired
	PatchLogMngService patchLogMngService;
	...
	public ResponseEntity<List<?>> selectList(@RequestParam HashMap<String, Object> params, HttpServletRequest request) throws Exception {
		...
		List<?> gList = patchLogMngService.selectList(params, request);
