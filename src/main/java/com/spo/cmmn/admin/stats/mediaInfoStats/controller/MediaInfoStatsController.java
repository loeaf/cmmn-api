package com.spo.cmmn.admin.stats.mediaInfoStats.controller;
...
@Controller
@RequestMapping(value="/api/admin/sys/mediaInfoStats")
public class MediaInfoStatsController {
	private final Logger LOGGER = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
	
	
	@Autowired
	MediaInfoStatsService mediaInfoStatsService;
	...
	public ResponseEntity<List<?>> selectList(@RequestParam HashMap<String, Object> params, HttpServletRequest request) throws Exception {
		...
		List<?> gList = mediaInfoStatsService.selectList(params, request);
